...
<html lang="en">
    ...
    <body id="page-top">
      <!-- facebook comment-->  
      <div id="fb-root"></div>
      <script async defer crossorigin="anonymous" src="https://connect.facebook.net/pt_BR/sdk.js#xfbml=1&version=v6.0&appId=1283260311736827&autoLogAppEvents=1"></script>
  <!--  end facebook comment--> 
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto my-2 my-lg-0" >
                       ...
                       <!-- <li class="nav-item"><a class="nav-link js-scroll-trigger"  href="#services">Sistemas</a></li>-->
						...
						<li class="nav-item"><a class="nav-link js-scroll-trigger"  href="https://nfeguard.com.br/blog/calculadoraipva/brasil/consulta-ipva-2020-brasil-tabela-fipe-carros">Carros</a></li>
        ...
        <header class="masthead">
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-10 align-self-end">
                        <h1 class="text-uppercase text-white font-weight-bold">Tabela Fipe - Caminhões</h1>
          ...
          <div class="col-md-4 form-group pr-md-1">
            <select name="vehicles" id="vehicles" style="width: 100%; border-radius: 4px;" required>
              <option class="form-control" value="">Selecione o caminhão</option>
            </select>
            <br>
          </div>
          <div class="col-md-4 form-group pr-md-1">
          ...
          <div class="col-md-4 form-group pr-md-1">
            <p style="color: white;">
              Valor IPVA <span style="font-size:12px;">(aproximado 1%)</span>
            </p>
          ...
          <div class="col-md-12 form-group pr-md-1">
            ...
            <a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=http://nfeguard.com.br/blog/calculadoraipva/brasil/consulta-ipva-2020-brasil-tabela-fipe-caminhoes" class="facebook">
              <i class="bx bxl-facebook" style="font-size: 2em;"></i>
            </a> &nbsp;&nbsp;&nbsp;&nbsp;
            <a href="https://www.linkedin.com/sharing/share-offsite/?url=http://nfeguard.com.br/blog/calculadoraipva/brasil/consulta-ipva-2020-brasil-tabela-fipe-caminhoes" target="_blank" class="linkedin">
            ...
            <a href="whatsapp://send?text=http://nfeguard.com.br/blog/calculadoraipva/brasil/consulta-ipva-2020-brasil-tabela-fipe-caminhoes" data-action="share/whatsapp/share" target="_blank" class="whatsapp" >
        ...
        <script src="/js/javascript_caminhoes.js"></script>
