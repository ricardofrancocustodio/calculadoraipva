...
<html lang="en">
  ...
  <!--  end facebook comment--> 
        ...
        <header class="masthead">
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-10 align-self-end">
                        <h1 class="text-uppercase text-white font-weight-bold">Tabela Fipe - motos</h1>
          ...
          <div class="col-md-4 form-group pr-md-1">
            <select name="vehicles" id="vehicles" style="width: 100%; border-radius: 4px;" required>
              <option class="form-control" value="">Selecione a moto</option>
            </select>
            <br>
          </div>
          <div class="col-md-4 form-group pr-md-1">
          ...
          <div class="col-md-4 form-group pr-md-1">
            <p style="color: white;">
              Valor IPVA <span style="font-size:12px;">(aproximado 2%)</span>
            </p>
          ...
          <div class="col-md-12 form-group pr-md-1">
            ...
            <a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=http://nfeguard.com.br/blog/calculadoraipva/brasil/consulta-ipva-2020-brasil-tabela-fipe-motos" class="facebook">
              <i class="bx bxl-facebook" style="font-size: 2em;"></i>
            </a> &nbsp;&nbsp;&nbsp;&nbsp;
            <a href="https://www.linkedin.com/sharing/share-offsite/?url=http://nfeguard.com.br/blog/calculadoraipva/brasil/consulta-ipva-2020-brasil-tabela-fipe-motos" target="_blank" class="linkedin">
            ...
            <a href="whatsapp://send?text=http://nfeguard.com.br/blog/calculadoraipva/brasil/consulta-ipva-2020-brasil-tabela-fipe-motos" data-action="share/whatsapp/share" target="_blank" class="whatsapp" >
        ...
        <script src="/js/javascript_motos.js"></script>
