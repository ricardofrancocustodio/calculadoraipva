...
$action = $_GET['action'];
	...
	*/
	...
	if ($action == 'brand')
	{
		$obFipe->setUrl("https://fipeapi.appspot.com/api/1/motos/marcas.json");
	...
	
	{
		...
		$obFipe->setUrl("https://fipeapi.appspot.com/api/1/motos/veiculos/{$brandId}.json");
	...
	{
		$obFipe->setUrl("https://fipeapi.appspot.com/api/1/motos/veiculo/{$brandId}/{$vehicleId}.json");
