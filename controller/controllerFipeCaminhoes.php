...
$action = $_GET['action'];
	...
	*/
	...
	if ($action == 'brand')
	{
		$obFipe->setUrl("https://fipeapi.appspot.com/api/1/caminhoes/marcas.json");
	...
	
	{
		...
		$obFipe->setUrl("https://fipeapi.appspot.com/api/1/caminhoes/veiculos/{$brandId}.json");
	...
	{
		$obFipe->setUrl("https://fipeapi.appspot.com/api/1/caminhoes/veiculo/{$brandId}/{$vehicleId}.json");
